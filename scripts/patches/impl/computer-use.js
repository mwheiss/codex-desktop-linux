...
function computerUseUiSettingsAppId(env) {
  const appId = env.CODEX_LINUX_APP_ID || env.CODEX_APP_ID || "hydex-desktop";
  return /^[A-Za-z0-9._-]+$/.test(appId) ? appId : "hydex-desktop";
}
